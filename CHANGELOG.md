...
- **Chaos got three more tricks**: she can steal a widget and waddle off-screen with it (tidy brings it back), run a full parkour line hurdling every widget without touching one, or stage a dramatic inspection that ends in nothing at all.
