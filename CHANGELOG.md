...
- **Mascot across the shell**: ~18 static surfaces (About, empty states, session screen, boot greeting, update overlay, docs landing) behind one switch, four hidden bar gestures that summon her, and a desktop widget with its own pose picker.
