...
- **Arrange settings** (Settings › Arrange): reorder the settings sidebar to your taste — move groups up/down, rename them, create new ones, and send any page to any group. Search always finds everything regardless of arrangement; one click resets to defaults.
