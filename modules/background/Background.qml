...
Scope {
    ...
    PanelWindow {
        ...
        // The wallpaper is the one surface where hiding on fullscreen is right:
        // it is fully occluded by definition and has no interaction value, and a
        // video wallpaper would keep decoding frames nobody can see. That call
        // belongs to the user's own hideWhenFullscreen preference, though — not
        // to GameMode overriding it.
